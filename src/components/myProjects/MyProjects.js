    ...
    <div id='projects'>
      ...
      <div className={classes.parent} >
        ...
        <div className={classes.div2}>
          ...
          <div className={classes.btnContainer}>
            <a href="https://music-player-008.netlify.app/login" target="_blank" rel="noopener noreferrer"><button className={classes.btnProj}>Go Live</button></a>
        ...
        <div className={classes.div3}>
          ...
          <div className={classes.btnContainer}>
            <a href="https://carcare-90.netlify.app/" target="_blank" rel="noopener noreferrer"><button>Go Live</button></a>
        ...
        <div className={classes.div4}>
          ...
          <div className={classes.textContainer}>
            <h3>Recipe mealDb</h3>
            <p>A Web Application which provide recipes to cook various dishes built using Node.js where a user can add, remove, update, and veiw recepies on youtube.</p>
          </div>
          <div className={classes.btnContainer}>
